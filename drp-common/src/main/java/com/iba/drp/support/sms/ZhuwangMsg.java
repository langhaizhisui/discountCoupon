package com.iba.drp.support.sms;

import com.iba.drp.config.Resources;
import com.iba.drp.config.SpringContentRegister;
import com.iba.drp.support.thread.PushMessagePool;
import com.iba.drp.util.HttpClientUtil;
import com.iba.drp.util.StringUtil;
import com.iba.drp.util.XmlUtil;
...
import static com.iba.drp.config.Resources.PHONE;
...
public final class ZhuwangMsg {
     ...
     * @see com.iba.drp.support.sms.MessageConstant.exCode
     */
