 ...
 * @Description:
 * @author sonic.liu
 * @date 2016年5月6日 Copyright (c) 2016, hanapark.cn All Rights Reserved.
 * @since JDK 1.7
 */
...
public final class RegexUtils {
	...
	public static void main(String[] args) {
		System.out.println(isDate("2014/11/12 11:22"));
		System.out.println(Pattern.matches("^[0-9]{4}-(0[1-9]|1[0-2])", "0017-12"));
	}
