...
public final class DateUtil {
	...
	public static void main(String[] args) {
		try {
			...
			// Date b = sf.parse("2016-10-08 08:00:00");
			// Date e = sf.parse("2016-10-08 10:00:00");
			// System.out.println(getDayBetween(b,e));
			// System.out.println(getHourBetween(b,e));
			// System.out.println(getMinuteBetween(b,e));
			// System.out.println(sf.format(getLastWeekStartTime()));
			// System.out.println(sf.format(getLastWeekEndTime()));
			// System.out.println(sf.format(getLastMonthStartTime()));
			// System.out.println(sf.format(getLastMonthEndTime()));
			// Date beginTime = new
			// SimpleDateFormat("yyyy-MM-dd").parse("2017-02-13");
			// Date endTime = new
			// SimpleDateFormat("yyyy-MM-dd").parse("2017-02-14");
			// System.out.println(DateUtil.getDayBetween(beginTime, endTime) +
			// 1);
			System.out.println(getMonthEndTime("2017-02"));
			System.out.println(getMonthStartTime("2017-02"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
