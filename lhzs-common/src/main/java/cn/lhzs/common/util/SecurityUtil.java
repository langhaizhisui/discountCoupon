...
import cn.lhzs.common.support.security.BASE64Encoder;
import cn.lhzs.common.support.security.coder.*;
...
public final class SecurityUtil {
	 ...
	 * @return
	 */
	public static final String encryptDrpUserPWD(String pwd) {
		return encryptMd5(encryptSHA(pwd));
	}
