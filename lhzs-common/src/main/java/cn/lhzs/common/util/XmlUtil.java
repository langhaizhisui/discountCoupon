...
//import cn.lhzs.common.constant.CharSetConstant;
...
//        try (StringReader read = new StringReader(xmlString)){
...
//
//        return op.toString(StringUtil.isBlank(charSet) ? CharSetConstant.UTF_8 : charSet);
//    }
//
//}
