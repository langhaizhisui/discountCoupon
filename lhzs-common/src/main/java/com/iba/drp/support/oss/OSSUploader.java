package com.iba.drp.support.oss;

import com.aliyun.oss.ClientException;
import com.aliyun.oss.OSSClient;
import com.aliyun.oss.OSSException;
import com.aliyun.oss.model.ObjectMetadata;
import com.iba.drp.exception.FtpException;
...
import static com.iba.drp.config.Resources.IMAGE;
...
public final class OSSUploader {
    ...
    private OSSUploader() {
        endPoint = IMAGE.getString("ibalife.album_url");
        accessId = IMAGE.getString("oss.key.id");
        secret = IMAGE.getString("oss.key.secret");
        bucketName = IMAGE.getString("oss.bucket.name");
        client = new OSSClient(endPoint, accessId, secret);

        litimgWidth = Integer.parseInt(IMAGE.getString("ibalife.pic.litimg.width"));
        litimgHeight = Integer.parseInt(IMAGE.getString("ibalife.pic.litimg.hight"));
    }
